...
?>
  ...
  <form method = "post">
		   ...
		   <input type = "submit" name = "new_thread" value = "Post Thread"/>
		   <input type = "submit" id = "red_posts" name = "red_posts" value = "back"/>
	</form>
      ...
      if(isset($_POST['red_posts'])){
	   ...
	   function save_thread($thread){
			  $db1= new mysqli('localhost','londoners','London123!','Londoners');
				...
				$qry = "insert into post_threads (post_master_id,member_id,previous_thread_id,thread_data) values (".$_SESSION['thread_post_id'].",1,1,'".$thread."');";
